...
const CopyButton = ({ copy }) => {
    return (
        <button onClick={copy} className="z-50 absolute bottom-16 right-2 w-8 h-8 rounded-full bg-gradient-to-tr from-fsgreen to-fsapple flex items-center justify-center scale-125 hover:scale-[1.3] transition-all duration-300 active:scale-[0.8] active:blur-md">
